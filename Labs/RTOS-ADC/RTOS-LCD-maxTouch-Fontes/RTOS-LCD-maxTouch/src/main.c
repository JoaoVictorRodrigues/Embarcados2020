  ...
  while (true) {
	...
	// Busca um novo valor na fila do adc!
	    ...
	    if (xQueueReceive( xQueueADC, &(adc), ( TickType_t )  100 / portTICK_PERIOD_MS)) {
		      ...
		      font_draw_text(&calibri_36, b, 50, 200, 0);
	    }
		if (adc.value < 4096/3){
			ili9488_set_foreground_color(COLOR_CONVERT(COLOR_GREEN));
			ili9488_draw_filled_circle(50, 50, 50);
			
			ili9488_set_foreground_color(COLOR_CONVERT(COLOR_WHITE));
			ili9488_draw_filled_circle(150, 50, 50);
			ili9488_set_foreground_color(COLOR_CONVERT(COLOR_YELLOW));
			ili9488_draw_circle(150, 50, 50);
			
			ili9488_set_foreground_color(COLOR_CONVERT(COLOR_WHITE));
			ili9488_draw_filled_circle(250, 50, 50);
			ili9488_set_foreground_color(COLOR_CONVERT(COLOR_RED));
			ili9488_draw_circle(250, 50, 50);
		}
		else if(adc.value>2*4096/3){
			ili9488_set_foreground_color(COLOR_CONVERT(COLOR_WHITE));
			ili9488_draw_filled_circle(50, 50, 50);
			ili9488_set_foreground_color(COLOR_CONVERT(COLOR_GREEN));
			ili9488_draw_circle(50, 50, 50);
